...
root.configure(background="#EEEED5")

Tops=Frame(root,width=1350,height=50,bd=8,bg="#EEEED5")
Tops.pack(side=TOP)

f1=Frame(root,width=600,height=600,bd=8,bg="#EEEED5")
f1.pack(side=LEFT)
f2=Frame(root,width=300,height=700,bd=8,bg="#EEEED5")
f2.pack(side=RIGHT)

fla=Frame(f1,width=600,height=200,bd=8,bg="#EEEED5")
fla.pack(side=TOP)
flb=Frame(f1,width=300,height=600,bd=8,bg="#EEEED5")
flb.pack(side=TOP)
...
lblName=Label(fla,text="Name",font=('arial',16,'bold'),bd=20,fg="#3D3D3D",bg="#EEEED5").grid(row=0,column=0)
lblAddress=Label(fla,text="Address",font=('arial',16,'bold'),bd=20,fg="#3D3D3D",bg="#EEEED5").grid(row=0,column=2)
lblEmployer=Label(fla,text="Employer",font=('arial',16,'bold'),bd=20,fg="#3D3D3D",bg="#EEEED5").grid(row=1,column=0)
lblNINumber=Label(fla,text="NI Number",font=('arial',16,'bold'),bd=20,fg="#3D3D3D",bg="#EEEED5").grid(row=1,column=2)
lblHoursWorked=Label(fla,text="Hours Worked",font=('arial',16,'bold'),bd=20,fg="#3D3D3D",bg="#EEEED5").grid(row=2,column=0)
lblHourlyRate=Label(fla,text="Hourly Rate",font=('arial',16,'bold'),bd=20,fg="#3D3D3D",bg="#EEEED5").grid(row=2,column=2)
lblTax=Label(fla,text="Tax",font=('arial',16,'bold'),bd=20,anchor='w',fg="#3D3D3D",bg="#EEEED5").grid(row=3,column=0)
lblOverTime=Label(fla,text="OverTime",font=('arial',16,'bold'),bd=20,fg="#3D3D3D",bg="#EEEED5").grid(row=3,column=2)
lblGrossPay=Label(fla,text="GrossPay",font=('arial',16,'bold'),bd=20,fg="#3D3D3D",bg="#EEEED5").grid(row=4,column=0)
...
btnsalary=Button(flb,text='Weekly Salary',padx=16,pady=16,bd=8,font=('arial',16,'bold'),width=14,fg="#3D3D3D",bg="#EEEED5",command=weeklywages).grid(row=0,column=0)
